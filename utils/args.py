...
def parse_args():
    ...
    parser.add_argument("--pdc", type=int, default=1)
...
def analyze_args():
    ...
    parser.add_argument("--data_dir", type=str, default=r"E:\LZK\codeWork\python\items\AcademicResearch\my\dataset\PU-bearing-dataset-min")
    parser.add_argument("--model_path", type=str, default=r"E:\LZK\codeWork\python\items\AcademicResearch\my\logs_real\RDFTL\temp\RDFTL-best.tar")
    parser.add_argument("--model_type", type=int, default=1)
    parser.add_argument("--state", type=str, default="0")
    parser.add_argument("--way", type=str, default="mix")
    return parser.parse_args()
